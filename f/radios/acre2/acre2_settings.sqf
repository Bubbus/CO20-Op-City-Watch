...
f_radios_settings_acre2_extraRadios = ["dc", "ftl", "sl", "med", "zeus"];
...
f_radios_settings_acre2_languages = [["english","Big boy words"]];
...
f_radios_settings_acre2_lr_groups_blufor = [
    ["GRND COMMAND 1",    ["ALPHA","BRAVO","COMMAND","MORTAR","ZEUS","MMG1","HMG1","MAT1","HAT1","MTR1","MSAM1","HSAM1","ST1","DT1"]],
